				...
				$.ajax({
					...
					data : {"memberId" : $("#memberId").val()},
				 	success : function(result){
				 		if(result == "isDuple") {
				 			$("#overlapMsg").html("<span style='color:green;'>다시한번 체크하세요!</span>");
				 			isValidId = false;
				 		}else if (result == "isNotDuple" ) {
				 			$("#overlapMsg").html("<span style='color:green;'>사용가능한 아이디입니다.</span>");
				 			isValidId = true;
						}
				 	}
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="checkout__form__input">
                                    ...
                                    <input type="button" id="BtncheckDuple" value="중복확인" ><br>
                                    <span id="overlapMsg"></span>
                                </div>
                                <div class="checkout__form__input">
                                    <p>비밀번호 </p>
